    ...
    acc.add(
        ...
        |builder| {
            ...
            for ret_expr_arg in exprs_to_unwrap {
                ...
                if ret_expr_str.starts_with("Some(") || ret_expr_str.starts_with("None") {
                ...
                // todo: maybe handle None differently? 
            }
        },
    )
}
...
"#,
    ...
    #[test]
    fn unwrap_option_return_type_simple_return_type_already_not_result_std() {
        check_assist_not_applicable(
            unwrap_option_return_type,
            r#"
//- minicore: option
...
"#,
    ...
    #[test]
    fn unwrap_option_return_type_simple_return_type_already_not_result_closure() {
        check_assist_not_applicable(
            unwrap_option_return_type,
            r#"
//- minicore: option
